...
public class TAC_parser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (STRING|NUMBER|ifInst|switchInst|gotoInst|KEYWORDS|PRIMITIVETYPE|MODIFIER|EXTENDS|IMPLEMENTS|JAVATYPEHEAD|THROW|THROWS|VOID|THIS|LEVEL|COMMA|DOT|SEMICOLON|COLON|AT|R_ARROW|L_ARROW|"[]"|"("|")"|"["|"]"|"%"|COMPARATORS|DIVID|OPERATORS|CONSTMETHODNAMES|EQ|UEQ|STRINGVAR|PLUS|MINUS)*
  ...
  /* ********************************************************** */
  // "if" LBRACKET LEVEL ("<="|">="|"<"|">"|"=="|"!=") (NUMBER|LEVEL) RBRACKET gotoInst
  ...
  /* ********************************************************** */
  // "switch" LBRACKET LEVEL RBRACKET LBRACKET((NUMBER|"default") COLON gotoInst SEMICOLON?)* RBRACKET
