...
public class SaveFile {
    ...
    public static final void saveFile(String data,String path) throws InputNullException,NotEnoughRightsException,
            IsNotAFileException,ErrorWritingFileException {
        if( path == null ) {
