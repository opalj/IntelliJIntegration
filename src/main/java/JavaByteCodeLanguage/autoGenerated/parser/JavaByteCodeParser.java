...
public class JavaByteCodeParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // MNEMONIC (JType ":" Type                            // put someFQN : someFQN
  //                                     | "("NUMBER")"
  ...
  /* ********************************************************** */
  // MethodHead LBRACKET InstructionHead InstructionBody* LocVarTableDeclaration?
  // StackMapTableDeclaration? RBRACKET
  ...
  /* ********************************************************** */
  // StackMapTableHead StackMapTableBody*
  static boolean StackMapTableDeclaration(PsiBuilder b, int l) {
    ...
    r = r && StackMapTableDeclaration_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // StackMapTableBody*
  private static boolean StackMapTableDeclaration_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "StackMapTableDeclaration_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!StackMapTableBody(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "StackMapTableDeclaration_1", c)) break;
    }
    return true;
  }
