...
public class JavaByteCodeParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // "pc" EQ LBRACKET NUMBER TO NUMBER RBRACKET SLASH "lv" EQ NUMBER TO STRINGVAR COLON ("<"?(STRINGVAR "/"? SEMICOLON?)*">"? SEMICOLON?)*
  ...
  private static boolean LocVarTypeTableBody_14_0(PsiBuilder b, int l) {
    ...
    r = r && LocVarTypeTableBody_14_0_1(b, l + 1);
    r = r && LocVarTypeTableBody_14_0_2(b, l + 1);
    r = r && LocVarTypeTableBody_14_0_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // (STRINGVAR "/"? SEMICOLON?)*
  private static boolean LocVarTypeTableBody_14_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!LocVarTypeTableBody_14_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "LocVarTypeTableBody_14_0_1", c)) break;
    }
    return true;
  }

  // STRINGVAR "/"? SEMICOLON?
  private static boolean LocVarTypeTableBody_14_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, STRINGVAR);
    r = r && LocVarTypeTableBody_14_0_1_0_1(b, l + 1);
    r = r && LocVarTypeTableBody_14_0_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // "/"?
  private static boolean LocVarTypeTableBody_14_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_1_0_1")) return false;
    consumeToken(b, SLASH);
    return true;
  }

  // SEMICOLON?
  private static boolean LocVarTypeTableBody_14_0_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_1_0_2")) return false;
    consumeToken(b, SEMICOLON);
    return true;
  }

  // ">"?
  private static boolean LocVarTypeTableBody_14_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_2")) return false;
    consumeToken(b, ">");
    return true;
  }

  // SEMICOLON?
  private static boolean LocVarTypeTableBody_14_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LocVarTypeTableBody_14_0_3")) return false;
    consumeToken(b, SEMICOLON);
    return true;
  }
  ...
  // LocVarTableDeclaration?
  private static boolean MethodDeclaration_3_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MethodDeclaration_3_0_3")) return false;
