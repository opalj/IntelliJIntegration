...
public class JavaByteCodeParser implements PsiParser, LightPsiParser {
  ...
  //                                     | "("NUMBER")"
  //                                     | "("((JavaOP|NUMBER|STRING)','?)*")"   // LDC("someString") or ALOAD(5) or ...
  //                                     | JavaOP)?
  ...
  /* ********************************************************** */
  // MethodHead LBRACKET (InstructionHead InstructionBody* LocVarTableDeclaration? StackMapTableDeclaration?)* RBRACKET
  ...
  // (InstructionHead InstructionBody* LocVarTableDeclaration? StackMapTableDeclaration?)*
