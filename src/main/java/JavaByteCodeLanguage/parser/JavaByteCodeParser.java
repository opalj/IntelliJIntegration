...
public class JavaByteCodeParser implements PsiParser, LightPsiParser {
  ...
  // (Type ','?)*
  private static boolean MethodName_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MethodName_1_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!MethodName_1_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "MethodName_1_0_1", c)) break;
    }
    return true;
  }

  // Type ','?
  private static boolean MethodName_1_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MethodName_1_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Type(b, l + 1);
    r = r && MethodName_1_0_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ','?
  private static boolean MethodName_1_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "MethodName_1_0_1_0_1")) return false;
    consumeToken(b, ",");
    return true;
  }
