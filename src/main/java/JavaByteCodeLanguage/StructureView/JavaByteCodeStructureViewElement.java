...
import JavaByteCodeLanguage.autoGenerated.psi.impl.JavaByteCodeStackMapTableDeclarationImpl;
...
public class JavaByteCodeStructureViewElement
  ...
  /**
   * iterates over all methods in the designated method area
   * and creates an entry for the respective elements (methods and tables)
      ...
      if(method instanceof JavaByteCodeLocVarTableDeclaration) {
        treeElements.add(
                new JavaByteCodeStructureViewElement(
                        (JavaByteCodeLocVarTableDeclarationImpl) method));
      }
