...
public class JumpToResolve extends AnAction {
    private final String editorName;

    JumpToResolve(String editorName){this.editorName = editorName;}
    @Override
    public void actionPerformed(AnActionEvent e) {
        ...
        PsiElement fullyQualifiedClass = "OPAL-DIS".equals(editorName)? PsiTreeUtil.getParentOfType(elementAt, JavaByteCodeJType.class):
        ...
        if (fullyQualifiedClass != null) {
            ...
            FileEditorManager.getInstance(project)
                    .openFile(resolvedVirtualFile,true);
