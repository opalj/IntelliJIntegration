...
public class JumpBetweenEditors extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if(elementAt.getParent() == null || elementAt.getParent().getParent() == null
        ...
        for (FileEditor fileEditor : fileEditors) {
            if (fileEditor.getName().equals(srcEditorName)) {
                ...
                otherFile.accept(new PsiElementVisitor() {
                    @Override
                    public void visitElement(PsiElement element) {
                        super.visitElement(element);
                        // ~= element instanceof SomeClass (e.g. JavaByteCodeMethodName)
                        System.out.println("outside: " + element + " ... " + element.getClass().getSimpleName());
                        if(destMethodName.isInstance(element)) {
                            System.out.println("here:" + element + " ... " + element.getClass().getSimpleName());
