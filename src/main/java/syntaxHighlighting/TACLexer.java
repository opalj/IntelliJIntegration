...
class TACLexer implements FlexLexer {
  ...
  private static final String ZZ_ACTION_PACKED_0 =
      "\2\0\2\1\1\2\1\3\1\4\1\5\2\6\2\7" + "\1\3\1\7\1\0\2\4\1\0\1\2\2\6";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 = "\2\0\5\1\1\11\6\1\1\0\2\1\1\0\3\1";
  ...
  /**
   * Translates characters to character classes Chosen bits are [9, 6, 6] Total runtime size is 1568
   * bytes
   */
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1:
            {
              yybegin(YYINITIAL);
              return TAC_elementTypeHolder.KEY;
            }
            // fall through
          case 8:
            break;
          ...
          case 5:
            {
              ...
              return TAC_elementTypeHolder.SEPARATOR;
            }
            // fall through
          case 12:
            break;
          case 6:
            {
              yybegin(YYINITIAL);
              return TAC_elementTypeHolder.VALUE;
            }
            // fall through
          case 13:
            break;
