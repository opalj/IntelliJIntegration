...
public class MyStructureView implements StructureView {
    ...
    public MyStructureView(MyHtmlEditor htmlEditor, OpalEditorBasedStructureViewModel model, Project project, boolean isRootNodeShown) {
    ...
    public JComponent getComponent() {
        StructureView view = StructureViewFactory.getInstance(project).createStructureView(htmlEditor, opalModel, project, isRootNodeShown);
