...
public class DecompileFromJar {
    ...
    public static void openDialog(Project project, VirtualFile virtualFile, String editorName) {
        ...
        FileChooser.chooseFile(fileChooserDescriptor, project, virtualFile, vf -> openAndDecompile(project, vf, editorName));
    }

    public static void openAndDecompile(Project project, VirtualFile selectedFile, String editorName) {
